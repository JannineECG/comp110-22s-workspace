"""This course is dependant on TA's  therefore students are struggling to understand the concepts."""
...
def count(fre: list[str]) -> dict[str, int]:
    """The data of difficulty of the course, how well students are undertsanding the course, the pace, office hours visit, and effectiveness."""
    end: dict[str, int] = {}
    for key in fre:
        if key in end:
            end[key] += 1
